...
#include <Actors/Ships/ScoutWespeActor.h>

/*
* Patrol actor.
*/

struct FleetSimple : Actor
{
  u32              mInstanceId;
  ...
  FleetSimple(std::string const& name, Object* pObject, u32 instanceId)
  ...
  {
    static r32v3 targetPosition{};

    r32v3 delta{ targetPosition - mTransform.mPosition };
    ...
    if (distance > 100.f)
      ...
      mTransform.mPosition += direction * 5.f * timeDelta;
