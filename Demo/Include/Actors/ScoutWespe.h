...
struct ScoutWespe : Actor
{
  ...
  Renderable& mRenderable{ ACS::Attach<Renderable>(this, &ModelDatabaseGet("ScoutWespe").mMesh, &ModelDatabaseGet("ScoutWespe").mTextureAlbedo, &ModelDatabaseGet("ScoutWespe").mTextureSpecular, nullptr, nullptr, nullptr) };

  ScoutWespe(Object* pObject) : Actor(pObject) {}
